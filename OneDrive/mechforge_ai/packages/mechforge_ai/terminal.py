...
class MechForgeTerminal:
    ...
    def _call_api(self, user_input: str):
        ...
        # 检查是否需要 RAG
        context = ""
        use_rag = self.rag_enabled or (self.rag_engine.is_available and self.rag_engine.check_trigger(user_input))
...
def main():
    ...
    parser = argparse.ArgumentParser(
        prog='mechforge',
        description='MechForge AI - Mechanical Engineering AI Assistant'
    )
